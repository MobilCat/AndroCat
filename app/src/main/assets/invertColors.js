javascript: (
    function() {
        var css = 'html {-webkit-filter: grayscale(50%) invert(100%);' +
            '-moz-filter: grayscale(50%) invert(100%);' +
            '-o-filter: grayscale(50%) invert(100%);' +
            '-ms-filter: grayscale(50%) invert(100%); }'+
        ...
        function getNormalColors() {
            ...
            document.getElementsByClassName('col-12 col-md-8 col-lg-6 p-responsive mt-3 border-bottom')[0].style.backgroundColor = lightBlue;
            document.getElementsByClassName('team-left-column col-12 col-md-3 col-lg-3 pr-5 mt-5 hide-lg hide-md hide-sm border-bottom')[0].style.backgroundColor = lightBlue;
        }
    })()